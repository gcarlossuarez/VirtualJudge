...
### **PASO 0: Identificación Obligatoria** 🆔
⚠️ **NUEVO:** Antes de poder usar cualquier funcionalidad del Juez Virtual, **debes seleccionar tu nombre** de la lista de estudiantes.

- Al seleccionar tu nombre, aparecerá un mensaje de bienvenida con tu nombre e ID
- **Verifica que sea tu nombre correcto** antes de continuar
- Todos los botones permanecerán deshabilitados hasta que te identifiques
- Todas tus actividades quedarán registradas para evaluación

### Flujo Principal:

1. **👤 Selecciona tu nombre** en el dropdown de estudiantes (obligatorio)
2. **📋 Selecciona un problema** del contest
3. **✍️ Escribe tu programa** (por ejemplo, en C#)
4. **🧪 Pruébalo en Sandbox Local** (recomendado, ver sección 6)
5. **📤 Envía tu programa al Juez Virtual:**
